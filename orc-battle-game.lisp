...
(defmethod monster-attack(( m slime-mold))
  (let ((x (randval (slime-mold-sliminess m))))
    ...
    (when (zerop (random 2))
      (princ "It also squirts in you face, taking away a health point! ")
      (decf *player-health* ))))
...
(defmethod monster-attack (( m brigand))
  (let (( x (max *player-health* *player-agility* *player-strength* )))
    (cond ((= x *player-health*)
	  ...
	  ((= x *player-agility* )
	   (princ "A brigand catches you leg with his whip, taking off 2 agility points! ")
	   (decf *player-agility* 2))
	  ((= x *player-strength* )
	   (princ "A brigand cuts you arm with his whip, taking off 2 strength points! ")
